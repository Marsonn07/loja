  ...
  <section id="produto">
    ...
    <div class="container-flex">
      <div class="produto-imagem">
        <img src="assets/manga_longa.png" alt="Imagem do Produto">
      </div>
      <div class="produto-detalhes">
        <h3>manga longa</h3>
        <p>R$ 90,00</p>
        <p>
    Nossa camiseta manga longa é a peça perfeita para quem busca conforto, estilo e versatilidade. Ela é leve, respirável e macia ao toque, ideal para os dias de calor. O corte garante um caimento perfeito no corpo, valorizando suas curvas.
<br>
<br>
