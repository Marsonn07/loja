  ...
  <section id="produto">
    ...
    <div class="container-flex">
      <div class="produto-imagem">
        <img src="assets/regata.jpg" alt="Imagem do Produto">
      </div>
      <div class="produto-detalhes">
        <h3>Regata</h3>
        <p>R$ 99,90</p>
        <p>Conforto e estilo para seus dias mais quentes!

Nossa regata é a peça perfeita para quem busca conforto, estilo e versatilidade. Ela é leve, respirável e macia ao toque, ideal para os dias de calor. O corte garante um caimento perfeito no corpo, valorizando suas curvas.
<br>
<br>
